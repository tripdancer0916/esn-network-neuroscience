...
def calculate_memory_capacity(mu, r_sig, average_degree, num_community):
    ...
    for k in range(30):
        W = generate_networks.make_feedforward_layered_network(N_NODES, average_degree, num_community, mu)
...
if __name__ == '__main__':
    ...
    np.savetxt('./mc-result/result_rsig_{}_averagedegree_{}_ncom_{}_ff.out'.
